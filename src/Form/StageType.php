        ...
        $builder
            ->add('etudiant', EntityType::class, [
                ...
                'choice_attr' => function (Etudiant $e) {
                    $promotion = $e->getAnnPromotion();

                    return [
                        'data-date-debut' => $promotion && $promotion->getDateDebutStage()
                            ? $promotion->getDateDebutStage()->format('Y-m-d')
                            : '',
                        'data-date-fin' => $promotion && $promotion->getDateFinStage()
                            ? $promotion->getDateFinStage()->format('Y-m-d')
                            : '',
                    ];
                },
                'label' => 'Étudiant (*)',
