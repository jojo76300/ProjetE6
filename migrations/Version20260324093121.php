 ...
 */
final class Version20260324093121 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(\App\Triggers\TriArchiveStageAjout::getTrigger());
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql("DROP TRIGGER IF EXISTS Tri_Archive_Stage_Ajout;");
    }
}
