 ...
 */
final class Version20260324082233 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(\App\Triggers\TriHistoryEtudiant::getTrigger());
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql("DROP TRIGGER IF EXISTS Tri_History_Etudiant;");
    }
}
