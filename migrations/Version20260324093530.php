 ...
 */
final class Version20260324093530 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(\App\Triggers\TriHistoryStage::getTrigger());
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql("DROP TRIGGER IF EXISTS Tri_History_Stage;");
    }
}
