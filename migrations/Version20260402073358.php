 ...
 */
final class Version20260402073358 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE promotion (id INT AUTO_INCREMENT NOT NULL, classe VARCHAR(50) NOT NULL, session VARCHAR(30) NOT NULL, date_debut_stage_defaut DATE NOT NULL, date_fin_stage_defaut DATE NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
