 ...
 */
final class Version20260324091942 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(\App\Triggers\TriHistoryEntreprise::getTrigger());
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql("DROP TRIGGER IF EXISTS Tri_History_Entreprise;");
    }
}
